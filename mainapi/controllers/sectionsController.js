...
module.exports = {
	get: async function(req, res) {
		...
		if (type == undefined || !['domain', 'branch', 'course', 'chapter'].includes(type)) {
	...
	post: async function(req, res) {
		...
		if (name == undefined || type == undefined || image == undefined) {
			...
			case 'branch':
				...
				} else if (await Domains.getBySectionId(req.body.domainId) == null) {
				...
				break;
			case 'course':
				if (req.body.branchId == undefined || req.body.authorId == undefined) {
					response = 'Paramètres manquants';
				} else if (await Branches.getBySectionId(req.body.branchId) == null) {
				...
				break;
			case 'chapter':
				if (req.body.courseId == undefined || req.body.index == undefined) {
					response = 'Paramètres manquants';
				} else if (await Courses.getBySectionId(req.body.courseId) == undefined) {
